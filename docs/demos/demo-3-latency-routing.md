...
- Linux traffic control (`tc`) for network simulation
...
Continue to [Demo 4: GeoIP-Based Routing](demo-4-geoip-routing) to learn about geographic traffic distribution.
